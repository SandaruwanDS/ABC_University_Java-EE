 ...
 * @author PC
 */
@WebServlet(name = "viewUserDegreeController", urlPatterns = {"/viewUserDegree"})
public class viewUserDegreeController extends HttpServlet {
    Connection con;
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("user/viewDegree.jsp").forward(request, response);
